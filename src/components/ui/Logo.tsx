...
export const Logo: React.FC<LogoProps> = ({ size = 32, className = "" }) => (
    ...
    >
        <div className="transition-transform group-hover:scale-105 duration-500">
            <RefinedIcon size={size} />
        </div>
        <div className="flex items-baseline leading-none tracking-tight">
            <span className="font-medium text-[22px] lowercase text-white font-institutional">inspiron</span>
            <span className="font-light text-[20px] uppercase text-[#FFD700] ml-1 font-institutional">TECH</span>
        </div>
    </div>
);
